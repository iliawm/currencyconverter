...
const CheckRateOptions = ({ Last, Open, calc, calcp, Recieve, send }: CheckRateOptionsProps) => {
    ...
    useEffect(() => {
        const newDates = handleDates(period);
        fetchRates(newDates);
    }, [period]);
                    ...
                    <div className="History w-full h-fit gap-5 flex-col flex items-start justify-center">
                        <div className="stats flex justify-between items-center w-full">
                            ...
                            <div className="flex items-center bg-[#171719] px-2 rounded-lg py-2 text-xs mt-5 font-bold">
                                <button
                                    className="cursor-not-allowed text-gray-400 w-full rounded-md px-3 py-2 bg-red-400 disabled:text-black"
                                    disabled
                                ...
                                <button
                                    ...
                                    onClick={() => { setactive(1); setPeriod(7); }}
                                >
                                    1W
                                </button>
                                <button
                                    ...
                                    onClick={() => { setactive(2); setPeriod(30); }}
                                >
                                    1M
                                </button>
                                <button
                                    ...
                                    onClick={() => { setactive(3); setPeriod(90); }}
                                >
                                    3M
                                </button>
                                <button
                                    ...
                                    onClick={() => { setactive(4); setPeriod(365); }}
                                >
                                    1Y
                                </button>
                                <button
                                    ...
                                    onClick={() => { setactive(5); setPeriod(1825); }}
                                >
                                    5Y
                                </button>
                            </div>
                        ...
                        <div className="chart w-full h-fit bg-[#171719] flex flex-col p-10 rounded-lg">
                            <div className="flex justify-between items-center mb-4">
                                <h1 className="font-bold text-lg text-white">{send}/{Recieve}</h1>
                            ...
                            <div style={{ width: '100%', height: 300 }}>
                                {loading ? (
                                    ...
                                    <div className="w-full h-full flex flex-col items-center justify-center text-red-500 gap-4">
                                        ...
                                        <button
                                            onClick={retryFetch}
                                            className="px-4 py-2 bg-red-500 text-white rounded-lg  transition cursor-pointer hover:opacity-85"
                                        >
                                            Retry
                                        </button>
                                    </div>
                                    ...
                                    <ResponsiveContainer width="100%" height="100%">
                                        <LineChart data={chartData}>
                                            ...
                                            <Tooltip
                                                ...
                                                formatter={(value: any) => {
                                                    if (typeof value === 'number') return [value.toFixed(4), 'Rate'];
                                                    return [String(value ?? '-'), 'Rate'];
                                                }}
                                                labelFormatter={(label: any) => `Date: ${formatDate(String(label ?? ''))}`}
                                            />
                                            <Line
                                                type="monotone"
                                                dataKey="rate"
    ...
    return (
        <div className='w-full flex flex-col h-fit'>
            <div className="flex gap-5 border-b border-gray-800 w-full font-bold text-sm">
                <button className={`cursor-pointer hover:opacity-90 border-b ${index === 0 ? "border-[#778b2d]" : "border-gray-800"} pb-4`} onClick={() => setIndex(0)}>HISTORY</button>
                <button className={`cursor-pointer hover:opacity-90 border-b ${index === 1 ? "border-[#778b2d]" : "border-gray-800"} pb-4`} onClick={() => setIndex(1)}>COMPARE</button>
                <button className={`cursor-pointer hover:opacity-90 border-b ${index === 2 ? "border-[#778b2d]" : "border-gray-800"} pb-4`} onClick={() => setIndex(2)}>FAVORITES</button>
                <button className={`cursor-pointer hover:opacity-90 border-b ${index === 3 ? "border-[#778b2d]" : "border-gray-800"} pb-4`} onClick={() => setIndex(3)}>LOG</button>
            </div>
