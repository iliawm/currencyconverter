...
const Ratecards = ({ Last, Open, calc, calcp }: RatecardsProps) => {
    ...
    return (
        <div className='w-fit flex lg:gap-6 mt-5 flex-wrap items-center justify-center md:flex-nowrap gap-6 md:gap-1 '>
            <div className=" flex flex-1 flex-col gap-4 rounded-xl bg-[#171719] py-4 pr-14 border border-gray-900 pl-3 items-start justify-center md:shrink-0 font-bold text-gray-400">
            ...
            <div className="flex flex-1 flex-col gap-4 rounded-xl bg-[#171719] py-4 pr-14 border border-gray-900 pl-3 items-start justify-center md:shrink-0 font-bold text-gray-400">
                <div className='tag text-[12px] flex text-nowrap '>% CHANGE</div>
