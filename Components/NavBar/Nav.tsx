...
const Nav = () => {
  ...
  <div className="flex w-full h-32 flex-col  ">
    <div className='w-full h-20 bg-[#0a0a0a]  flex p-1 gap-4 shrink-0'>
        ...
        <div className="w-full flex items-center h-full justify-around md:justify-end md:pr-5 text-neutral-200 text-[10px] md:gap-4 text-pretty pl-2">
            <h3>
                {Amount.toUpperCase()}
            </h3>
            <div>
    ...
    <div className="w-full h-full bg-neutral-700  flex overflow-x-scroll overflow-y-hidden items-center justify-start">
        <Link href={"/liveMarkets"} className="flex w-fit h-full items-center justify-center px-3 bg-lime-500 text-neutral-900 gap-1 text-[12px] font-bold" autoCapitalize="on">
        <div>
        ...
        {/* Here i have to add a live cms with updates on prices */}
    </div>
    </div>
  )
}
